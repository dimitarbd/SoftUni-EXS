function legendaryFarming(str) {
    ...
    let keyEntries = Object.entries(keyMaterials).sort((a, b) => b[1] - a[1] || a[0].localeCompare(b[0]));
    for (let [material, qty] of keyEntries) {
        console.log(`${material}: ${qty}`);
    }

    let junkEntries = Object.entries(junkMaterials).sort((a, b) => a[0].localeCompare(b[0]));
